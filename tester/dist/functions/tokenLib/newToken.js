...
function newToken(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createToken_1.createToken(data)];
                case 1:
                    newAuthToken = _a.sent();
                    return [4 /*yield*/, logController_1.newLog(newAuthToken, "log/authToken.log")];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, writeToken_1.writeToken(newAuthToken.data)];
                case 3:
                    _a.sent();
                    return [2 /*return*/, newAuthToken.data.access_token];
            }
        });
    });
}
