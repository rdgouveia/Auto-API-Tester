...
var getCache_1 = require("./getCache");
var newToken_1 = require("./newToken");
/**
...
function getToken(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getCache_1.getCache()];
                case 1:
                    authToken = _a.sent();
                    if (authToken.message === "error") {
                        return [2 /*return*/, newToken_1.newToken(data)];
                    }
                    if (Date.now() / 1000 - authToken.time > authToken.expires_in - 60) {
                        return [2 /*return*/, newToken_1.newToken(data)];
                    }
                    else {
                        return [2 /*return*/, authToken.access_token];
                    }
                    return [2 /*return*/];
            }
        });
