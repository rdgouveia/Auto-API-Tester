        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, writeLog_1.appendFile(path, logBody)];
                case 1:
                    _a.sent();
                    if (!(path !== "log/authToken.log")) return [3 /*break*/, 3];
                    return [4 /*yield*/, writeLogResume_1.logResume(data.status)];
                case 2:
                    _a.sent();
                    _a.label = 3;
