        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (auth !== null) {
                        data.api.headers = __assign(__assign({}, data.api.headers), { authorization: "Bearer " + auth });
                    }
                    return [4 /*yield*/, request_1.req(data.api)];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, logController_1.newLog(response, "log/api.log")];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
